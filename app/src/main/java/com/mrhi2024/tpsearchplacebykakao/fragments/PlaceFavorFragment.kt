...
import com.mrhi2024.tpsearchplacebykakao.databinding.FragmentPlaceFavorBinding
    ...
    private fun loadData() {
        ...
        cursor?.apply {
            ...
            for (i in 0 until count) {
                ...
                val address_name = getString(3)
                val road_address_name = getString(4)
                val x = getString(5)
                val y = getString(6)
                val place_url = getString(7)
                val distance = getString(8)
                val category_name = getString(9)
            ...
            // ListData를 리사이클러뷰에 아이템뷰로 보이도록 아답터 설정!
